---
tags: [modozaint-v2, estrategia, ingresos, ia, ecommerce]
updated: 2026-09-01
tipo: decision
status: accepted
owner: santiago
...
# Vehículo de ingresos - 2026-09-01

## Decisión de Santiago

El objetivo de los próximos 12 meses es pasar de `0 COP/mes` fuera del salario a una facturación
...
- **Dermatinta:** ecommerce propio donde aplicar y demostrar IA en operación, contenido, marketing y
  crecimiento.
- **House of Kaizen:** negocio de productos físicos e infoproductos alrededor del tufting; deja de
...
- Los proyectos propios son laboratorios reales, no demos ficticias.
- Cada automatización debe resolver un problema real antes de convertirse en oferta.
- La IA se aplica donde aumente capacidad, reduzca trabajo manual o mejore decisiones; no se agrega
  por moda.
- La oferta debe nacer de evidencia de uso y resultados, no de promesas abstractas.
- Los negocios propios comparten aprendizaje, pero mantienen identidad, clientes y contabilidad
  separados.
