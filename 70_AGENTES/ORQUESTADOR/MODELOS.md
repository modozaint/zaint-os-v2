...
# Enrutamiento de modelos de ORQUESTADOR

| Forma del trabajo | Motor inicial | Escalado |
|---|---|---|
| Entrevista, bitácora, resumen corto, coordinación y reescritura rápida | ChatGPT/OpenAI equilibrado | OpenAI de máxima capacidad si hay herramientas o razonamiento difícil |
| Diseño, síntesis extensa, políticas y cierre largo | Claude equilibrado | Claude de máxima capacidad para horizonte largo |
